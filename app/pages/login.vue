<template>
  <div class="space-y-6">
    <form class="flex flex-col w-full space-y-6" @submit.prevent="login">
    ...
    <div class="flex items-center justify-center space-x-2 text-xs">
      ...
      <div class="text-xs">
        <NuxtLink class="hover:text-black-600" to="/forgot-password"
    ...
    <div
      class="flex items-center justify-center gap-2 pt-2 mt-2 border-t border-zinc-800 text-zinc-600"
    >
      <a
        target="_blank"
      ...
      >
        <IconsAndriodIcon class="w-6 h-6" />
      </a>
      <a
        target="_blank"
